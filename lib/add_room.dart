...
Future<void> main() async {
  ...
  runApp(new MaterialApp(home: new AddRoom()));
}
...
class _AddRoomState extends State<AddRoom> {
  ...
  static String uid = '1';
  final DatabaseReference database = FirebaseDatabase.instance.ref("Room/$uid");
                ...
                Padding(
                    ...
                    child: ElevatedButton(
                      ...
                      style: ButtonStyle(
                        ...
                        foregroundColor:
                            MaterialStateProperty.all<Color>(Color(0xffE13737)),
                      ),
                    ))
              ],
            ),
                  ...
                  Padding(
                      ...
                      child: SizedBox(
                        ...
                        child: FloatingActionButton(
                            ...
                            foregroundColor: Color(0xffffad27),
